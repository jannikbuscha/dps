  ...
  return (
    <div className="controls">
      <div className="ctrlbar">
        ...
        <div className="toggle on" id="voiceTog" title="Toggle narration voice"><i className="ico ico-voice" id="voiceIco" aria-hidden="true"></i> Voice</div>
        <div className="toggle on" id="capTog" title="Toggle captions"><i className="ico ico-cc" aria-hidden="true"></i> Captions</div>
