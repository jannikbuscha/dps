// The full scene list, in playback order.
//
// This combines the analytical teardown scenes with the recurring "Lena"
// storyline (chapters marked `story:true`, no:"✦"). The Lena chapters used to
// live in a separate story.js and were spliced in at runtime; they are now
// inlined here at their real narrative positions (after scenes 05, 09 and 13).
// Lena is fully introduced in the intro (scene 01); the chapters CONTINUE her
// story without re-introducing her. Characters recur (Lena, recruiter Marco,
// mutual connections Anna & Tom) with real photos from /public/images.
// Scenes with their own `steps` array reveal content gradually.
export const scenes = [
  ...
  { no:"✦", kick:"Lena · Chapter 1", thread:null, story:true,
    steps:[
  ...
  { no:"✦", kick:"Lena · Chapter 2", thread:null, story:true,
    steps:[
  ...
  { no:"✦", kick:"Lena · Chapter 3", thread:null, story:true,
    steps:[
